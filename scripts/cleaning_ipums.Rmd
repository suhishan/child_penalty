...
Note: The child is linked to their father and mother via is the IPUMS family pointer i.e. for every row, this will the woman's own child. We probably only have information on married women aged 15-49 on their children
...
write_rds(df, 'transformed_data/selected_f_ipums.Rds')
write_rds(df_m, 'transformed_data/selected_m_ipums.Rds')
